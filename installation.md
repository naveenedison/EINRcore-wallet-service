...
```bash
npm install EINRcore-wallet-service
cd EINRcore-wallet-service
```
...
```
### Configuration
Configuration for all required modules can be specified in https://github.com/naveenedison/EINRcore-wallet-service/blob/master/config.js
...
EINRcore Wallet Service - bws.js
